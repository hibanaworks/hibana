//! Route projection WireFirst test (compile-pass).
//!
//! Passive role can disambiguate by first recv label (functional dispatch).
...
// Control messages for self-send
// (different labels, so controller can distinguish)
