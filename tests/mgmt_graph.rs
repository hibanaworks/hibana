...
const OBSERVE_APP: g::ProgramSource<ObserveAppSteps> = g::send::<
    g::Role<{ mgmt::ROLE_CONTROLLER }>,
    g::Role<{ mgmt::ROLE_CLUSTER }>,
    g::Msg<121, ()>,
    0,
>();
const OBSERVE_PROGRAM: g::ProgramSource<ObserveProgramSteps> =
    ...
    with_fixture(|clock, tap_buf, slab| {
        with_tls_ref(
            ...
            |cluster| {
                ...
                let prefix = g::freeze(&mgmt::observe_stream::PREFIX);
    ...
    with_fixture(|clock, tap_buf, slab| {
        with_tls_ref(
            ...
            |cluster| {
                ...
                let program = g::freeze(&OBSERVE_PROGRAM);
                let controller_program =
