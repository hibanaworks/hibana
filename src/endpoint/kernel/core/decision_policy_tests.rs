...
#[test]
fn decision_policy_enforces_scope_match_before_route_handle() {
...
#[test]
fn decision_policy_rejects_empty_scope() {
...
#[test]
fn decision_policy_allows_static_route_scope_without_policy_scope() {
