...
type Left = g::Seq<
    g::Send<2, 0, g::Msg<107, ()>>,
    g::Seq<
        g::Send<0, 2, g::Msg<101, ()>>,
        g::Seq<g::Send<2, 1, g::Msg<109, ()>>, g::Send<1, 2, g::Msg<103, ()>>>,
    >,
>;
type Right = g::Seq<
    g::Send<2, 0, g::Msg<108, ()>>,
    g::Seq<
        g::Send<0, 2, g::Msg<102, ()>>,
        g::Seq<g::Send<2, 1, g::Msg<110, ()>>, g::Send<1, 2, g::Msg<104, ()>>>,
    >,
>;
    ...
    g::route(
        g::seq(
            ...
            g::seq(
                g::send::<0, 2, g::Msg<101, ()>>(),
                g::seq(
                    g::send::<2, 1, g::Msg<109, ()>>(),
                    g::send::<1, 2, g::Msg<103, ()>>(),
                ),
            ),
        ),
        g::seq(
            ...
            g::seq(
                g::send::<0, 2, g::Msg<102, ()>>(),
                g::seq(
                    g::send::<2, 1, g::Msg<110, ()>>(),
                    g::send::<1, 2, g::Msg<104, ()>>(),
                ),
            ),
        ),
    )
