...
mod tests {
    ...
    type LargeChoreographyKit<'a> =
        SessionKitStorage<'a, LargeChoreographyTransport, CounterClock, 2>;
    ...
    fn retain_large_choreography_symbols() {
        ...
        let _ = linear_program::run
            as fn(&mut localside::ControllerEndpoint<'_>, &mut localside::WorkerEndpoint<'_>);
        let _ =
            linear_program::controller_program as fn() -> crate::runtime::program::RoleProgram<0>;
        let _ = fanout_program::run
            as fn(&mut localside::ControllerEndpoint<'_>, &mut localside::WorkerEndpoint<'_>);
        let _ =
            fanout_program::controller_program as fn() -> crate::runtime::program::RoleProgram<0>;
        let _ =
