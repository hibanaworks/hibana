...
pub const PROGRAM: Program<ProgramSteps> =
    crate::g::advanced::compose::seq(REQUEST_ROUTE, REPLY_ROUTE);
...
const _: () = assert_program_covers_facets(&CONTROLLER_PROGRAM, MGMT_FACET_NEEDS);
const _: () = assert_program_covers_facets(&CLUSTER_PROGRAM, MGMT_FACET_NEEDS);
