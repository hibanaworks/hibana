...
EXPECTED_STATIC_AUDIT_MARKER="Lean static theorem audit passed theorems=687 both=350 propext=242 free=95"
...
static_audit_output="$(python3 \
  ...
  --static "${PROOF_DIR}" "${STATIC_CLAIM_SNAPSHOT}" 687 350 242 95)"
printf '%s\n' "${static_audit_output}"
...
echo "Lean proof gate passed toolchain=v4.30.0 traces=14 frames=66 projections=22 exact-descriptors=22 progress=4 projectability=8 distributed-progress=8 verified-protocols=8 static-theorems=687 anonymous-regressions=36 generated-theorems=506 generated-obligations=458 production-transitions=7 production-operations=6 production-owners=8 verified-codecs=3 verified-family=8 static-deployments=8 deployment-rejections=3 capabilities=6 runtime-regions=4 atomic-failures=4 public-operation-edges=16 public-operation-transitions=144 native-regressions=32"
